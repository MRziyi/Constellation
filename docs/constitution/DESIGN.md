...
| OQ-3 | Glass HUD 视觉语言 | ✓ 已落地 → [Doc/ui-mockup.html](../../Doc/ui-mockup.html) + [UI-UX.md](../glass/UI-UX.md) |
...
- **Companion**: [INTERFACE-CONTRACTS.md](../server/INTERFACE-CONTRACTS.md) · [COMPONENT-DESIGN.md](../server/COMPONENT-DESIGN.md) · [DATA-MODEL.md](../server/DATA-MODEL.md) · [UI-UX.md](../glass/UI-UX.md) · [CORTEX-ROUTER-PROMPT.md](../server/CORTEX-ROUTER-PROMPT.md) · [TOOL-ADAPTERS.md](../server/TOOL-ADAPTERS.md) · [twin-seed/](../../../Constellation-Server/twin-seed/) · [IMPLEMENTATION-PLAN.md](../roadmap/IMPLEMENTATION-PLAN.md) · [TOOL-IDEAS.md](../roadmap/TOOL-IDEAS.md) · [halo-ring-plugin-protocol.md](../cross-device/halo-ring-plugin-protocol.md) · [Doc/ui-mockup.html](../../Doc/ui-mockup.html) · [Doc/brand/](../../Doc/brand/)
...
| v0.5 | #8 UI/UX 落地：[Doc/ui-mockup.html](../../Doc/ui-mockup.html) + [UI-UX.md](../glass/UI-UX.md)；继承 Halo Ring 视觉语言；2 个 global gesture (Quick Shortcut + Voice Invoke)；HUD options 改 Send/Feedback（不再 Reject）；新增 Feedback Loop 迭代机制（[INTERFACE-CONTRACTS §1.5](../server/INTERFACE-CONTRACTS.md)）；OQ-3/OQ-6 关闭 |
| v0.6 | mockup 重构为"两类 surface"清晰结构（HUD atom-based + 极简 app 设置 + 强制通用 card 模板 + 加 face recognition 验证模板适配性）；手势/profile 完全推给 Halo Ring；新增 [halo-ring-plugin-protocol.md](../cross-device/halo-ring-plugin-protocol.md) 给 Halo Ring agent；brand mark 落地 [Doc/brand/v1-constellation.svg](../../Doc/brand/v1-constellation.svg)（asymmetric 8-star asterism，9× 放大自 mockup inline mark）；#9 Implementation Plan 落地 [IMPLEMENTATION-PLAN.md](../roadmap/IMPLEMENTATION-PLAN.md)（9 phases + critical path + risk register） |
| v0.7 | **设计阶段收尾**：G1 [CORTEX-ROUTER-PROMPT.md](../server/CORTEX-ROUTER-PROMPT.md)（system prompt + 7 个 few-shot + 输出 schema）；G2 [TOOL-ADAPTERS.md](../server/TOOL-ADAPTERS.md)（6 adapters × 详细 action catalog）；G3 [twin-seed/](../../../Constellation-Server/twin-seed/) 13 个文件（ready-to-deploy Twin 种子）；IMPLEMENTATION-PLAN bumped v0.1→v0.2（hardware no longer blocking；Mac-first → Android-phone debug → Rokid deploy 三段式；新增 §8 Greenlight checklist） |
